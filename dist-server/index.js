...
const Index = lazy(() => import('./assets/Index-DJtabZf8.js'));
const Blog = lazy(() => import('./assets/Blog-C_C_rEyq.js'));
const BlogPost = lazy(() => import('./assets/BlogPost-DWWWtykw.js'));
const GlobalServices = lazy(() => import('./assets/GlobalServices-Bw7MxJOv.js'));
const StartupDevelopment = lazy(() => import('./assets/StartupDevelopment-DOEaX9ZN.js'));
const VibeCoding = lazy(() => import('./assets/VibeCoding-DpimYiWL.js'));
const PrivacyPolicy = lazy(() => import('./assets/PrivacyPolicy-CwxcVzSK.js'));
const TermsOfService = lazy(() => import('./assets/TermsOfService-D39FcklL.js'));
const CookiePolicy = lazy(() => import('./assets/CookiePolicy-CgA6Xz59.js'));
const NotFound = lazy(() => import('./assets/NotFound-CXrMCiZg.js'));
const SwitzerlandHub = lazy(() => import('./assets/SwitzerlandHub-N-bIQY-B.js'));
const UKHub = lazy(() => import('./assets/UKHub-B7DSXXug.js'));
const USHub = lazy(() => import('./assets/USHub-DYVn4x5f.js'));
const ItalyHub = lazy(() => import('./assets/ItalyHub-Cio5h4Ep.js'));
const SwitzerlandWebDevelopment = lazy(() => import('./assets/SwitzerlandWebDevelopment-ClptiPAh.js'));
const SwitzerlandSoftwareDevelopment = lazy(() => import('./assets/SwitzerlandSoftwareDevelopment-BUZ6Ntlx.js'));
const SwitzerlandStartupDevelopment = lazy(() => import('./assets/SwitzerlandStartupDevelopment-D0lgInN5.js'));
const UKWebDevelopment = lazy(() => import('./assets/UKWebDevelopment-CELFNcLD.js'));
const UKSoftwareDevelopment = lazy(() => import('./assets/UKSoftwareDevelopment-U6TLJgNh.js'));
const UKStartupDevelopment = lazy(() => import('./assets/UKStartupDevelopment-CMuh0e5l.js'));
const USAWebDevelopment = lazy(() => import('./assets/USAWebDevelopment-DCYZa2GF.js'));
const USASoftwareDevelopment = lazy(() => import('./assets/USASoftwareDevelopment-DkIzehU8.js'));
const USAStartupDevelopment = lazy(() => import('./assets/USAStartupDevelopment-CXbusmvx.js'));
const ItalyWebDevelopment = lazy(() => import('./assets/ItalyWebDevelopment-NjjSR3VH.js'));
const ItalySoftwareDevelopment = lazy(() => import('./assets/ItalySoftwareDevelopment-Cq3PTjRq.js'));
const ItalyStartupDevelopment = lazy(() => import('./assets/ItalyStartupDevelopment-DFxNXKnA.js'));
...
export { Button as B, Helmet as H, useAnalytics as a, cn as c, create, useToast as u };
