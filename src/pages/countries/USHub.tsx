...
import { ArrowRight, CheckCircle, TrendingUp, Shield, Clock, Users, ChevronRight, Code, Rocket, Zap, DollarSign, Globe, Star } from "lucide-react";
...
const USHub = () => {
  ...
  const services = [
    {
      ...
      description: 'Silicon Valley quality websites at European prices',
      icon: Code,
      features: ['Responsive Design', 'E-commerce Ready', 'SEO Optimized', 'Performance Focused']
    },
    {
      ...
      description: 'Enterprise software with American market focus',
      icon: Zap,
      features: ['Custom Solutions', 'API Integration', 'Cloud Deploy', 'Scalable Architecture']
    },
    {
      ...
      description: 'Launch your American startup with global talent',
      icon: Rocket,
      features: ['MVP Development', 'Market Validation', 'User Testing', 'VC Ready']
    }
  ];

  const testimonials = [
    {
      quote: "Bernof Co saved us $75,000 on our SaaS platform while delivering Silicon Valley quality. Their understanding of American business culture was exceptional.",
      author: "Sarah Johnson",
      role: "CEO, San Francisco Tech Startup",
      location: "San Francisco, CA"
    },
    {
      quote: "We needed to move fast in the competitive US market. Bernof Co delivered our MVP in 6 weeks with quality that impressed our investors.",
      author: "Michael Chen",
      role: "CTO, NYC Fintech",
      location: "New York, NY"
    },
    {
      quote: "As a Texas startup, we were surprised by the quality and cost savings. They understood our market and delivered exactly what we needed.",
      author: "Jessica Martinez",
      role: "Founder, Austin Innovation Hub",
      location: "Austin, TX"
    }
  ];
  ...
  const process = [
    {
      ...
      description: "We analyze your target market, competitors, and US-specific requirements including regulations and compliance.",
      icon: TrendingUp
    },
    {
      step: "2",
      title: "American Standards & Planning",
      description: "Ensure US compliance, security standards, and create a detailed development roadmap for the American market.",
      icon: Shield
    },
    {
      step: "3",
      title: "Global Development Team",
      description: "Our international team develops your solution with American market focus and Silicon Valley standards.",
      icon: Users
    },
    {
      step: "4",
      title: "US Launch & Scale",
      description: "Launch in the US market with ongoing support and optimization for American users and growth.",
      icon: Rocket
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-inter">
      <Helmet>
        <title>USA Digital Services Hub | American Web Development & Software Solutions | Bernof Co</title>
        <meta name="description" content="America's premier digital development partner. Save 65% on web development, software solutions, and startup services. Silicon Valley quality at European prices, serving US businesses coast to coast." />
        <meta name="keywords" content="USA digital services, American web development, Silicon Valley software development, US startup development, American tech solutions, US software outsourcing" />
        <link rel="canonical" href="https://bernofco.com/global-services/us" />
        <link rel="hreflang" hrefLang="en-us" href="https://bernofco.com/global-services/us" />
              ...
              <div className="space-y-8">
                <div className="space-y-6">
                  <div className="inline-flex items-center px-4 py-2 bg-brand-sage-light/50 rounded-full text-brand-teal-dark font-semibold text-sm">
                    ...
                    America's Premier Digital Partner
                  </div>
                  ...
                  <p className="text-xl text-gray-600 leading-relaxed">
                    Compete in America's demanding digital marketplace with Silicon Valley quality at European prices. 
                    Save 65% on development costs while serving US businesses from coast to coast.
                  </p>
                </div>

                {/* US Market Stats */}
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-brand-sage/30">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">US Digital Market 2024</h3>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex items-center space-x-3">
                      <DollarSign className="w-5 h-5 text-brand-teal" />
                      <span className="text-sm text-gray-700">$1.8T Tech Sector Value</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <TrendingUp className="w-5 h-5 text-brand-teal" />
                      <span className="text-sm text-gray-700">Talent Shortage: 87%</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Clock className="w-5 h-5 text-brand-teal" />
                      <span className="text-sm text-gray-700">Costs Up 45% Since 2020</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <Globe className="w-5 h-5 text-brand-teal" />
                      <span className="text-sm text-gray-700">Global Talent Access</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Button 
                    variant="outline"
                    onClick={() => scrollToSection('us-process')}
                ...
                <div className="grid grid-cols-3 gap-6 pt-8 border-t border-gray-200">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-brand-teal">$50k+</div>
                    <div className="text-sm text-gray-600">Project Savings</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-brand-teal">24hrs</div>
                    <div className="text-sm text-gray-600">Project Start</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-brand-teal">100%</div>
                    <div className="text-sm text-gray-600">US Compliant</div>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-white rounded-2xl shadow-2xl p-8 border border-brand-sage/30 relative overflow-hidden">
                  ...
                  <div className="space-y-6 relative z-10">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        <h3 className="text-lg font-semibold text-gray-900">US Success Story</h3>
                    ...
                    <div className="mt-6 p-4 bg-gradient-to-r from-brand-teal to-brand-teal-light rounded-xl text-white">
                      <div className="flex items-center justify-between">
                        <div>
                          <div className="text-sm opacity-90">US Client Success Rate</div>
      ...
      {/* Services Section */}
      <section className="py-24 bg-white" id="us-services">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-20">
              ...
              <p className="text-xl text-gray-600 max-w-4xl mx-auto">
                Comprehensive services tailored for the American market with Silicon Valley standards and global expertise.
              </p>
            </div>
                ...
                <div key={index} className="bg-white rounded-3xl p-8 shadow-lg border-2 border-gray-200 hover:border-brand-teal hover:shadow-xl transition-all duration-300 group">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      <div className="text-center">
                        <div className="text-sm text-gray-500">US Market Challenge</div>
      ...
      {/* Process Section */}
      <section className="py-24 bg-gradient-to-b from-gray-50 to-white" id="us-process">
        <div className="container mx-auto px-6">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-20">
              <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                Our US-Focused Development Process
              </h2>
              <p className="text-xl text-gray-600 max-w-4xl mx-auto">
                A proven approach that combines global expertise with deep American market understanding.
              </p>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-20">
              <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
                Trusted by American Businesses
              </h2>
              <p className="text-xl text-gray-600 max-w-4xl mx-auto">
                From Silicon Valley startups to Wall Street enterprises, see how we've helped US businesses succeed.
              </p>
            </div>
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl mb-12 opacity-90">
              Join American businesses leveraging global talent for digital transformation. 
              Silicon Valley quality at European prices.
            </p>
