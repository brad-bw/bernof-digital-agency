...
const AboutSection = () => {
  ...
  return <section id="about" className="py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 w-32 h-32 bg-gradient-to-r from-primary/3 to-accent/3 organic-shape blur-2xl animate-fluid-motion" style={{
        animationDelay: '10s'
      }}></div>
        
        {/* Additional subtle geometric elements */}
        <div className="absolute top-1/4 right-1/3 w-6 h-6 bg-accent/10 rounded-full animate-geometric-float" style={{
        animationDelay: '5s'
      }}></div>
        <div className="absolute bottom-1/4 left-1/4 w-8 h-8 bg-primary/10 curved-element animate-fluid-motion" style={{
        animationDelay: '7s'
      }}></div>
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">At Bernof Co, we combine strategic thinking with technical excellence to deliver digital solutions that transform businesses and drive sustainable growth.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div className="relative">
              ...
              <div className="space-y-3">
                {achievements.map((achievement, index) => <div key={index} className="flex items-start gap-3 relative">
                    <CheckCircle className="w-5 h-5 text-accent mt-1 flex-shrink-0" />
                    <span className="text-gray-700">{achievement}</span>
                    {index % 3 === 0 && <div className="absolute -left-8 top-0 w-2 h-2 bg-primary/10 rounded-full"></div>}
                  </div>)}
              </div>
            </div>

            <div className="space-y-6">
              {values.map((value, index) => <Card key={index} className="border-0 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 relative overflow-hidden group">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-primary via-primary/95 to-primary/90 rounded-3xl overflow-hidden">
              ...
              <div className="absolute top-1/2 right-1/3 w-24 h-24 bg-white/5 organic-shape blur-xl animate-fluid-motion" style={{
              animationDelay: '8s'
            }}></div>
            </div>
            ...
            <div className="relative z-10 p-8 md:p-12 text-center text-white">
              <div className="max-w-3xl mx-auto mb-12">
                ...
                <p className="text-xl opacity-90 leading-relaxed">Join successful businesses who trust Bernof Co to manage their digital future. Let's discuss how we can drive your growth together.</p>
              </div>

              {/* Enhanced feature cards with geometric elements */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                {ctaFeatures.map((feature, index) => <div key={index} className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-500 group relative overflow-hidden">
              ...
              <div className="flex flex-col items-center space-y-4">
                <Button onClick={() => document.getElementById('discovery-call')?.scrollIntoView({
                behavior: 'smooth'
