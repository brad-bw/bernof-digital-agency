            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <h1 className="text-5xl lg:text-7xl font-satoshi font-bold text-gray-900 leading-tight">
                  Web development
                  <span className="block text-brand-teal">che trasforma</span>
                </h1>
                ...
                <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-full px-4 py-2 text-sm font-satoshi">
                  ...
                  <span className="text-gray-700">Trusted by 80+ Italian businesses</span>
                </div>
                
                <p className="text-xl lg:text-2xl text-gray-600 font-satoshi leading-relaxed max-w-2xl">
                  Modernize your Italian business with cutting-edge websites and e-commerce solutions. Bridge the digital transformation gap with cost-effective, world-class development.
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 gap-6">
                  ...
                  <div className="flex items-center justify-between p-4 bg-red-50/50 rounded-2xl border border-red-100/50">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-sm font-satoshi text-slate-600">Italian agencies</span>
                    </div>
                    <div className="text-right">
                      <div className="text-2xl font-satoshi font-semibold text-slate-800">€10k–€24k</div>
                      <div className="text-xs font-satoshi text-red-600">limited expertise</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-emerald-50/50 rounded-2xl border border-emerald-100/50">
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-satoshi font-semibold text-slate-800">€4k–€9.6k</div>
                      <div className="text-xs font-satoshi text-emerald-600">advanced tech</div>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex items-center space-x-8 pt-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-600 font-satoshi">Same timezone</span>
                </div>
                <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-600 font-satoshi">GDPR compliant</span>
                </div>
              </div>
            </div>
