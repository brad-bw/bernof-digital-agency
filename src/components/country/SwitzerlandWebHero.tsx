...
export const SwitzerlandWebHero = () => {
  return (
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <h1 className="text-5xl lg:text-7xl font-satoshi font-bold text-gray-900 leading-tight">
                  Web development
                  <span className="block text-brand-teal">ohne Premium</span>
                </h1>
                ...
                <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-full px-4 py-2 text-sm font-satoshi">
                  ...
                  <span className="text-gray-700">Trusted by 120+ Swiss businesses</span>
                </div>
                
                <p className="text-xl lg:text-2xl text-gray-600 font-satoshi leading-relaxed max-w-2xl">
                  Cost-effective, high-quality websites and e-commerce solutions that help Swiss businesses compete globally while saving 60-70% on development costs.
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 gap-6">
                  ...
                  <div className="flex items-center justify-between p-4 bg-red-50/50 rounded-2xl border border-red-100/50">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-sm font-satoshi text-slate-600">Swiss agencies</span>
                    </div>
                    <div className="text-right">
                      <div className="text-2xl font-satoshi font-semibold text-slate-800">€13.5k–€31.5k</div>
                      <div className="text-xs font-satoshi text-red-600">premium pricing</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-emerald-50/50 rounded-2xl border border-emerald-100/50">
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-satoshi font-semibold text-slate-800">€5.4k–€12.6k</div>
