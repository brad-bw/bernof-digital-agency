      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        <div className="max-w-4xl">
          ...
          <h1 className="text-5xl lg:text-7xl font-bold tracking-tight mb-6">
            Digital
            <span className="block text-transparent bg-gradient-to-r from-[#20B2AA] to-[#4FD1C7] bg-clip-text px-0 mx-0 my-0 py-[12px]">
              Insights
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button size="lg" className="bg-[#20B2AA] hover:bg-[#1A9B95] text-white font-semibold px-8 py-3 rounded-full group text-base">
              Explore Articles
