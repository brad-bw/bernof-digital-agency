        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="/startup-development" className="hover:text-white">Startup Development</a></li>
              <li><a href="/global-services" className="hover:text-white">Global Services</a></li>
              <li><a href="/vibe-coding" className="hover:text-white">Vibe Coding</a></li>
            </ul>
          </div>
