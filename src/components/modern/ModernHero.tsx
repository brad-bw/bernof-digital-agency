      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-20">
            ...
            <h1 className="font-inter text-5xl md:text-7xl lg:text-8xl font-bold text-foreground leading-[0.9] tracking-tight mb-8">
              Build the future.
              <br />
              <span className="text-primary bg-clip-text">Ship today.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
              <Button 
                ...
                size="lg"
                className="bg-primary hover:bg-primary/90 text-primary-foreground font-medium px-10 py-4 rounded-xl text-lg transition-all duration-300 hover:scale-[1.02] group"
              >
              ...
              <Button 
                ...
                className="border-border text-foreground hover:bg-secondary font-medium px-10 py-4 rounded-xl text-lg"
              >
                View our work
              </Button>
            </div>
            ...
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-6">Trusted by startups and enterprises</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-card/50 border border-border rounded-2xl p-8 hover:bg-card transition-colors duration-300">
              <div className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center mb-6">
                <Code className="w-6 h-6 text-primary" />
              </div>
              <h3 className="text-xl font-semibold text-card-foreground mb-3">Development</h3>
            ...
            <div className="bg-card/50 border border-border rounded-2xl p-8 hover:bg-card transition-colors duration-300">
              ...
              <h3 className="text-xl font-semibold text-card-foreground mb-3">Design</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
            ...
            <div className="bg-card/50 border border-border rounded-2xl p-8 hover:bg-card transition-colors duration-300">
              ...
              <h3 className="text-xl font-semibold text-card-foreground mb-3">Growth</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
