      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 md:py-32">
        <div className="text-center max-w-5xl mx-auto mb-16">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-12">
            {['Ship in weeks, not months', 'Enterprise-grade quality', 'Fixed pricing', '24/7 support'].map((feature, i) => <div key={i} className="flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-border shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-20">
            <Button onClick={scrollToDiscoveryCall} size="lg" className="gradient-primary text-white font-semibold px-10 py-7 rounded-2xl text-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] group border-0">
        ...
        }].map((service, index) => <div key={index} className="group relative bg-white p-8 rounded-3xl border border-border hover:border-primary/30 transition-all duration-500 hover-lift">
